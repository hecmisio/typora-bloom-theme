...
目前包含 **10 套精心调配的莫兰迪配色**（5 套浅色 + 5 套深色）：
- **浅色系**：花瓣 (Petal), 雾蓝 (Mist), 草木 (Verdant), 暖石 (Stone), 陶土 (Terracotta)
- **深色系**：花瓣暗夜 (Petal Dark), 草木暗夜 (Verdant Dark), 陶土暗夜 (Terracotta Dark), 青蓝 (Cyber), 薰衣草紫 (Spring)
...
|:---|:---|:---|:---|:---|:---|
| **🌤 浅色 (5)** | **花瓣 Petal** | `L97% C0.01 H354` | `L55% C0.08 H354` | `L25% C0.02 H354` | 暖粉白 + 玫瑰粉 · 柔和温润 |
...
| | **陶土 Terracotta** | `L97% C0.01 H45` | `L55% C0.10 H45` | `L25% C0.02 H45` | 陶土橙调，复古温暖的写作体验 |
| **🌙 深色 (5)** | **花瓣暗夜 Petal Dark** | `L14% C0.02 H354` | `L62% C0.08 H354` | `L92% C0.01 H354` | 深玫瑰黑 + 玫瑰粉 · 安静的夜间粉调 |
| | **草木暗夜 Verdant Dark** | `L14% C0.02 H160` | `L65% C0.08 H160` | `L92% C0.01 H160` | 深墨绿 + 莫兰迪绿 · 幽静的暗夜森林 |
| | **陶土暗夜 Terracotta Dark** | `L14% C0.02 H45` | `L65% C0.10 H45` | `L90% C0.01 H45` | 篝火般的温暖陶土色 |
| | **青蓝 Cyber** | `L12% C0.02 H245` | `L75% C0.14 H230` | `L92% C0.01 H245` | 极深蓝黑 + 青蓝 · 科技感的护眼青 |
| | **薰衣草紫 Spring** | `L14% C0.02 H295` | `L68% C0.14 H295` | `L92% C0.01 H295` | 深紫黑 + 薰衣草紫 · 浪漫的夜间花海 |
