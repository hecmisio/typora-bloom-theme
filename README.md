...
| | **洋红 Magenta** | `L97% C0.01 H330` | `L60% C0.16 H330` | `L25% C0.02 H330` | 现代洋红，时尚且富有活力的视觉冲击 |
...
| | **洋红暗夜 Magenta Dark** | `L20% C0.02 H330` | `L70% C0.16 H330` | `L96% C0.01 H330` | 深紫黑 + 霓虹洋红 · 赛博朋克般的夜间视觉 |
